...
day_1b_test = "12131415"
day_1b_final = ""
day_2a_test = '''5 1 9 5
7 5 3
2 4 6 8'''
day_2a_final = '''179	2358	5197	867	163	4418	3135	5049	187	166	4682	5080	5541	172	4294	1397
...
9 4 7 3
3 8 6 5'''
day_2b_final = day_2a_final
day_4a_test = "aa bb cc dd aa"
day_4a_final = '''una bokpr ftz ryw nau yknf fguaczl anu
...
day_4b_final = '''una bokpr ftz ryw nau yknf fguaczl anu
tvay wvco bcoblpt fwzg sfsys zvuqll mcbhwz ovcw fgdy
ynsocz vid rfmsy essqt fpbjvvq sldje qfpvjvb
yvh nxc kla vhy vkbq cxfzgr
kljv ymobo jlvk ebst cse cmlub tavputz omoby psif
...
day_8a_test = '''b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10'''
day_8a_final = '''yxr inc 119 if nev != 6
piw dec -346 if tl != 4
...
day_12b_test = day_12a_test
day_12b_final = day_12a_final
